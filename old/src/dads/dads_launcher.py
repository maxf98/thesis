...
def run_experiment():
    ...
    aug_obs_spec = utils.aug_obs_spec(obs_spec, 2)
    aug_ts_spec = utils.aug_time_step_spec(time_step_spec, 2)
    ...
    discriminator = skill_dynamics.SkillDynamics(aug_obs_spec.shape, 2)
    ...
    policy_dir = os.path.join(tempdir, 'dads_policy')
    ...
    utils.unzip_to(policy_zip_filename, "logs/dads/policy")

    discriminator.save("logs/dads/discriminator")
